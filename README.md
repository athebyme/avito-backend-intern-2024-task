# Проект: Сборка приложения в Docker

Добро пожаловать в проект! Здесь представлен типовой пример сборки приложения с использованием Docker и Gradle. Пример может быть изменён под любые ваши нужды, с сохранением лишь нескольких базовых условий, описанных ниже.
