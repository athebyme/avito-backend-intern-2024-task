...
#### 7. Получение списка предложений пользователя
...
```
  
#### 8. Получение текущего статуса предложения
...
#### 9. Получение списка предложений для тендера
...
#### 11. Создание нового предложения
...
#### 12. Отправка решения по предложению (КВОРУМ)
...
#### 13. Отправка отзыва по предложению
...
#### 15. Просмотр отзывов на прошлые предложения
...
- #### Параметры запроса:
- `tenderId` : ID тендера, на который пришло предложение.
