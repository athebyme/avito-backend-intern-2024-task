...
1. откройте терминал с проектом и введите следующие команды:
2. отключите k8s pods
3. kubectl rollout restart deployment cnrprod1725773447-team-79619-backend --namespace=cnrprod1725773447-team-79619
